...
There are various types of convolution:
- Depthwise
- Pointwise
- Pixel Shuffle
- Dilated
...
More details of these can be found [here](https://github.com/divya-r-kamat/DeepVision/blob/main/AdvancedConvolution/ConvolutionTypes.md). The objective here is to apply these convolution on CIFAR10 dataset.

## Data Analysis

The CIFAR-10 dataset consists of 60000 32x32 colour images in 10 classes. There are 50000 training images and 10000 test images. Analysis on the dataset can be found [here](https://github.com/divya-r-kamat/DeepVision/blob/main/AdvancedConvolution/dataanalysis/DataAnalysis_CIFAR10Dataset.ipynb)
